...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/user/vendor/simple-line-icons/css/simple-line-icons.css"') }}>
  <link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Catamaran:100,200,300,400,500,600,700,800,900" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Muli" rel="stylesheet">

  <!-- Plugin CSS -->
  <link rel="stylesheet" href="{{ asset('assets/user/device-mockups/device-mockups.min.css') }}">

  <!-- Custom styles for this template -->
  <link href="{{ asset('assets/user/css/new-age.min.css') }}" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="{{ asset('assets/user/js/new-age.min.js') }}"></script>
